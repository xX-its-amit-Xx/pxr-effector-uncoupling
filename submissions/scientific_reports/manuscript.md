...
PXR (NR1I2) regulates xenobiotic metabolism, but target-gene responses are studied in bulk liver and assumed to generalise to any cell type expressing the receptor. We tested this at single-cell resolution using CELLxGENE Census v2025-01-30, computing metacell correlations between NR1I2 and 20 canonical targets across 446,672 cells from 10 cell types. Six targets (CYP2C9, CYP3A5, ABCC2, SLCO1B1, CYP2C8, CPT1A) couple strongly in hepatocytes (Spearman rho 0.77 to 0.89, BH q approximately 0.004) but only weakly in immune (mean rho 0.03 to 0.12) and placental cells (0.014) — a 4 to 8 fold effect-size differential. A matched 20-gene negative-control set is decoupled (median decoupling score 0.575 vs -0.126; Mann-Whitney U one-sided p = 1.0 x 10^-31), ruling out a generic hepatocyte signature. The pattern replicates in GTEx v8 bulk tissue and in LINCS L1000 (HEPG2 ranks first of 18 cell lines for rifampicin signature strength); direct rifamycin perturbation in primary human hepatocytes (GSE139896) confirms four (CYP2C8, CYP2C9, CYP3A5, ABCC2) with up to 19-fold induction, while SLCO1B1 and CPT1A appear hepatic-TF-coupled rather than directly PXR-induced. The CYP2C8 / CYP2C9 / CYP3A5 / ABCC2 panel is the actionable hepatocyte-selective readout for tissue-restricted PXR modulators; the metacell-coupling framework generalises to any receptor x cell-atlas pair.
